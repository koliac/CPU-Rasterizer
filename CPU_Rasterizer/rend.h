...
public:
	...
	GzTexture		tex_fun;    /* tex_fun(float u, float v, GzColor color) */
  	...
  	// Constructors
	GzRender(int xRes, int yRes, float xshiftScalar, float yshiftScalar);
	~GzRender();
...
private:
	short normMatlevel;
	int rasterize(GzCoord* vertList, GzCoord* normalList, GzTextureIndex* uvList, int interpMode, GzColor* vColorList);
};
#endif